...
class Arguments:
    def __init__(self):
        ...
        # Dataset arguments
        self._parser.add_argument('--data_path', type=str, default='e/animals_resize.csv', help='Dataset file path.')
        ...
        self._parser.add_argument('--epochs', type=int, default=2, help='Number of epochs of training.')

        # data arguments
        self._parser.add_argument('--hole_size', type=int, default=40, help='Generated results path.')
        self._parser.add_argument('--num_holes', type=int, default=2, help='Generated results path.')
