...
class Arguments:
    def __init__(self):
        ...
        # Dataset arguments
        self._parser.add_argument('--data_path', type=str, default='/home/jongjin/workspace/datasets/animals_resize/animals.csv', help='Dataset file path.')
        ...
        self._parser.add_argument('--epochs', type=int, default=1000, help='Number of epochs of training.')
        ...
        self._parser.add_argument('--pretrained', type=bool, default=False, help='Generated results path.')
    def parser(self):
        return self._parser
