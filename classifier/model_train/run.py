...
def run(args):
    weights_path = '/home/jongjin/st/DeepLearning-Model/classification/model/resnet18.pth'

    model = ResNet(backbone=args.backbone, num_classes=args.num_classes, weights_path=weights_path).to(device=args.device)
